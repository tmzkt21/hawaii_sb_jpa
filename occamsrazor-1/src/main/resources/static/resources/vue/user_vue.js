	...
	detail2 : ()=>{
		return `<div id="content_container">
				<table>
					...
					<tr>
						<td class="adminlabel">관리자번호</td>
						<td class="input">
							<p id="employNumber"></p>
						</td>
					</tr>
					<tr>
						<td class="adminlabel">비밀번호</td>
						<td class="input">
							<p id="passwd"></p>
						</td>
					</tr>
					<tr>
						<td class="adminlabel">직급</td>
						<td class="input">
							<p id="position"></p>
						</td>
					</tr>
					<tr>
						<td class="adminlabel">프로파일</td>
						<td class="input">
							<p id="profile"></p>
						</td>
					</tr>
					<tr>
						<td class="adminlabel">이메일</td>
						<td class="input">
							<p id="email"></p>
						</td>
					</tr>
					<tr>
						<td class="adminlabel">전화번호</td>
						<td class="input">
							<p id="userPhoneNumber"></p>
						</td>
					</tr>
					<tr>
						<td class="adminlabel">가입일</td>
						<td class="input">
							<p id="registerDate"></p>
						</td>
					</tr>
